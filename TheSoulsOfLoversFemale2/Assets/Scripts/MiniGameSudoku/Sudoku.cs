...
public class Sudoku
{
    ...
    {
        if(IsPossibleNumberInColumn(number, column) && IsPossibleNumberInRow(number, row))
        {
    ...
    private bool IsPossibleNumberInGroup(int nuumber, int group)
    {
